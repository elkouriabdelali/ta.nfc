...
class TagTechnologyNfcAProxy : public titanium::Proxy
{
public:
	explicit TagTechnologyNfcAProxy(jobject javaObject);
...
private:
	...
	static v8::Handle<v8::Value> getAtqa(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getSak(const v8::Arguments&);
